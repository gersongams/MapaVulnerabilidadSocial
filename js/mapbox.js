...
const toggleableLayersSocial = [
  { ids: ['tract', 'county'], name: ['Vulnerabilidad Social - General']},
  { ids: ['tract-socio','county-socio'], name: ['Vulnerabilidad Socioeconómica']},
  { ids: ['tract-household','county-household'], name: ['Vulnerabilidad de composición familiar y discapacidad']},
  { ids: ['tract-minority','county-minority'], name: ['Vulnerabilidad de idioma y estado de minoría']},
  { ids: ['tract-household','county-housing'], name: ['Vulnerabilidad de vivienda y transporteVulnerabilidad de vivienda y transporte']},
];
